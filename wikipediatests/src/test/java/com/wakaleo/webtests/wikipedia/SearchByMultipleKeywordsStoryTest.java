...
public class SearchByMultipleKeywordsStoryTest {
    ...
    @Test
    public void search_by_cat_and_dogs() {
        endUser.is_on_the_wikipedia_home_page();
		endUser.searches_using_several_terms("cats","dogs");
        endUser.should_see_all_terms("Cat", "Dog");
    }

    @Test
    public void search_by_apples_and_oranges() {
        endUser.is_on_the_wikipedia_home_page();
		endUser.searches_using_several_terms("apples","oranges");
        endUser.should_see_all_terms("Apple", "Orange");
    }
